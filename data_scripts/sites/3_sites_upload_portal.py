'''
Step 3: This script gets the current dated SWAMP station data file (from the export folder) and uploads it to the open data portal. If there is no directory in the export folder with the current date, then the script will not be able to locate the correct file and the script will not run.
...
if __name__ == '__main__':
    ...
    print('--- Uploading station data file')
    ...
    #resource_info = ckan.action.resource_show(id=p_constants.portal_resource_ids['stations'])
